...
head:
  ...
  - tag: link
    attrs:
      rel: canonical
      href: https://docs.slinkapp.io/usage/03-sharex-integration/
---
...
## Making uploads shareable

By default, uploads are private and a shared link only works once the image is published. To make ShareX uploads shareable immediately, open your account **Preferences** (a per-user setting in your own account, not the admin settings) and, under **Image Uploads**, enable **Auto-publish API uploads** (or set **Default Visibility** to Public).

![Auto-publish API uploads preference](../../screens/62f0bbfc-5150-483d-9b85-99940a36bf69.png)
