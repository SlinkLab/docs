...
description: Guide for setting up the first admin user in Slink. Manual setup via CLI commands and automatic admin creation via environment variables.
head:
  - tag: meta
    attrs:
      name: keywords
...
For the full list of admin variables and their requirements, see [Admin User (First-Run Setup)](/configuration/01-environment-variables/#admin-user-first-run-setup) in the Environment Variables reference.
