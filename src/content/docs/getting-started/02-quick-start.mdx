...
3. Open your browser and navigate to [https://your-domain.com/profile/signup](https://your-domain.com/profile/signup) to create a new account.
...
<Aside type="caution">
  The example command disables [user approval](/user-management/02-approve-user). It's
