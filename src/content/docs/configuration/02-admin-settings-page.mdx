...
<Aside type="caution" title="Important">
  ...
  See [Manage User Permissions](/user-management/03-manage-user-permissions) for more
  information.
</Aside>
...
For detailed configuration information, see [Storage Providers](/configuration/03-storage-provider) reference.
...
- **Require Auth for Media Shares**: Require visitors to be signed in to open shared images, even when the share itself is public
- **Require Auth for Collection Shares**: Require visitors to be signed in to open shared collections, even when the share itself is public
