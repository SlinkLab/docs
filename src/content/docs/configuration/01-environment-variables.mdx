...
description: Environment variables for configuring the application.
---
...
| `IMAGE_ALLOW_ONLY_PUBLIC_IMAGES`    | When enabled, all images are automatically set to public and visibility cannot be changed                                                  | `false`                 |
