...
5. Open your browser and navigate to [https://your-domain.com:3000/profile/signup](https://your-domain.com:3000/profile/signup) to create a new account (or login if you used automatic admin creation).
